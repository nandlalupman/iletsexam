...
import { Activity, Compass, Globe2, Sparkles, Users } from 'lucide-react';

const scrollCards = [
  { title: 'Structured Learning Path', description: 'Follow a proven curriculum designed to take you from foundation to mastery in 8 weeks.', gradient: 'from-primary via-blue-600 to-primary-700', icon: Compass },
  { title: 'AI-Powered Analytics', description: 'Track progress with intelligent dashboards that identify patterns and predict your score.', gradient: 'from-accent-orange via-red-500 to-pink-500', icon: Activity },
  { title: 'Community Support', description: 'Join 10,000+ students sharing tips, resources, and motivation on your IELTS journey.', gradient: 'from-green-500 via-emerald-500 to-teal-500', icon: Users },
  { title: 'Exam Day Strategy', description: 'Master time management, stress control, and strategic answering for exam day.', gradient: 'from-accent-yellow via-accent-orange to-red-500', icon: Sparkles },
  { title: 'Post-IELTS Support', description: 'Get guidance on visa, university shortlisting, and SOP writing after your exam.', gradient: 'from-purple-500 via-violet-500 to-indigo-500', icon: Globe2 },
];
        ...
        >
          {scrollCards.map((card, i) => (
            ...
            >
              ...
              <card.icon className="h-12 w-12 mb-6 text-white drop-shadow-md" strokeWidth={2.1} />
