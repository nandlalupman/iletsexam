...
const moduleCards = [
  { icon: Headphones, label: 'Listening', color: 'from-blue-500/20 to-blue-600/20', border: 'border-blue-500/30' },
  { icon: BookOpenText, label: 'Reading', color: 'from-emerald-500/20 to-emerald-600/20', border: 'border-emerald-500/30' },
  { icon: PenTool, label: 'Writing', color: 'from-purple-500/20 to-purple-600/20', border: 'border-purple-500/30' },
  { icon: Mic, label: 'Speaking', color: 'from-accent-orange/20 to-red-500/20', border: 'border-accent-orange/30' },
];
          ...
          >
            ...
            >
              <div className="px-6 py-3 rounded-2xl bg-gradient-to-r from-amber-500 to-yellow-400 shadow-lg shadow-amber-500/30">
                <span className="text-4xl sm:text-5xl font-black text-navy">EUR 490</span>
                <span className="text-navy/70 text-base font-bold ml-2">ONLY</span>
              </div>
              <div className="text-left">
                <p className="text-white/60 text-sm line-through">EUR 990</p>
            ...
            <p className="text-lg text-white/70 mb-8 max-w-xl mx-auto lg:mx-0 leading-relaxed">
              30-Day Intensive IELTS Program with <strong className="text-white/95">Expert Trainers</strong>,
              latest practice material, mock tests, and personal guidance.
            </p>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start mb-12">
              ...
              <a href="/tests/reading-foundations" className="inline-flex items-center justify-center gap-2 px-8 py-4 rounded-2xl border border-white/30 text-white font-semibold text-lg hover:bg-white/10 backdrop-blur-sm transition-all duration-300">
            ...
            <div className="grid grid-cols-3 gap-6 border-t border-white/10 pt-8">
              <div className="text-center lg:text-left">
                ...
                <p className="text-xs sm:text-sm text-white/55 mt-1 font-medium">Days Program</p>
              </div>
              <div className="text-center lg:text-left">
                <p className="text-3xl sm:text-4xl font-black text-white">4</p>
                <p className="text-xs sm:text-sm text-white/55 mt-1 font-medium">Max Students</p>
              </div>
              <div className="text-center lg:text-left">
                <p className="text-3xl sm:text-4xl font-black text-white">100%</p>
                <p className="text-xs sm:text-sm text-white/55 mt-1 font-medium">Money Back</p>
              </div>
            </div>
          </motion.div>
          ...
          >
            <div className="relative">
              ...
              <div className="relative rounded-[2.5rem] bg-white/[0.06] border border-white/10 backdrop-blur-xl p-8 sm:p-10 overflow-hidden">
                ...
                <div className="mb-8">
                  <p className="text-white/50 text-xs uppercase tracking-widest mb-5">IELTS Preparation Program</p>
                  <div className="grid grid-cols-2 gap-3">
                    {moduleCards.map((mod) => (
                      ...
                      >
                        <mod.icon className="h-6 w-6 text-white" strokeWidth={2.1} />
                  ...
                  {[
                    ...
                    >
                      <div className="w-6 h-6 rounded-full bg-green-500/20 border border-green-500/30 flex items-center justify-center flex-shrink-0">
                        <CheckCircle2 className="h-3.5 w-3.5 text-green-400" strokeWidth={2.5} />
                      </div>
            ...
            >
              <div className="flex items-center gap-3">
                <div className="w-10 h-10 rounded-full bg-green-500/20 flex items-center justify-center">
                  <CheckCircle2 className="h-5 w-5 text-green-400" strokeWidth={2.2} />
                </div>
                <div>
                  <p className="text-sm font-bold text-white">Guaranteed</p>
                  <p className="text-xs text-white/60">Or Money Back</p>
                </div>
              </div>
            </motion.div>
            ...
            >
              <div className="flex items-center gap-3">
                <Plane className="h-6 w-6 text-accent-yellow" strokeWidth={2.2} />
                <div>
                  <p className="text-xs text-white/60">Your Journey to</p>
            ...
            >
              <div className="flex items-center gap-2">
                <Trophy className="h-5 w-5 text-accent-yellow" strokeWidth={2.2} />
