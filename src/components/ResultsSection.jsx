...
import { BarChart3, Globe2, GraduationCap, Trophy } from 'lucide-react';
...
const stats = [
  { value: 10000, suffix: '+', label: 'Students Trained', icon: GraduationCap },
  { value: 7.5, suffix: '+', label: 'Avg Band Score', icon: BarChart3, isDecimal: true },
  { value: 95, suffix: '%', label: 'Success Rate', icon: Trophy },
  { value: 45, suffix: '+', label: 'Countries', icon: Globe2 },
];
      ...
      <div className="container-premium relative z-10">
        ...
        >
          {stats.map((stat) => (
            ...
            >
              <stat.icon className="mx-auto mb-3 h-8 w-8 text-primary" strokeWidth={2.1} />
              <div className="text-3xl lg:text-4xl font-bold text-navy mb-1">
                {stat.isDecimal ? <span>{stat.value}{stat.suffix}</span> : <AnimatedCounter target={stat.value} suffix={stat.suffix} />}
              </div>
          ...
          {successStories.map((story, i) => (
            ...
            >
              <div className="flex items-center justify-between mb-5">
                ...
                <span className="text-sm text-navy/60">{story.country}</span>
              </div>
