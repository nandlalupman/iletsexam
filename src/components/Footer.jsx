      ...
      <div className="relative z-10">
        <div className="container-premium section-padding !pb-8">
          ...
          <div className="flex flex-wrap items-center gap-6 py-8 border-t border-white/10 mb-8">
            <a href="mailto:hello@ieltspro.academy" className="flex items-center gap-2 text-sm text-white/50 hover:text-white transition-colors">
              ...
              hello@ieltspro.academy
            </a>
            <a href="tel:+919876543210" className="flex items-center gap-2 text-sm text-white/50 hover:text-white transition-colors">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-between gap-4 text-xs text-white/30">
            <p>&copy; {new Date().getFullYear()} IELTS Pro Academy. All rights reserved.</p>
