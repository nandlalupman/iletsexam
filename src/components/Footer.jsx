      ...
      <div className="relative z-10">
        <div className="container-premium section-padding !pb-8">
            ...
            {Object.entries(footerLinks).map(([title, links]) => (
              <div key={title}>
                ...
                <ul className="space-y-3">
                  {links.map((link) => (
                    <li key={link}>
                      <a href="#" className="text-sm text-white/75 hover:text-white transition-colors duration-200">{link}</a>
                    </li>
                  ))}
                </ul>
              </div>
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-8 py-8 border-t border-white/10 mb-8">
            <div>
              <h4 className="text-sm font-semibold text-amber-400 mb-3 uppercase tracking-wider flex items-center gap-2">
                <Building2 className="h-4 w-4" strokeWidth={2.2} /> India Office
              </h4>
            ...
            <div>
              <h4 className="text-sm font-semibold text-amber-400 mb-3 uppercase tracking-wider flex items-center gap-2">
                <Building2 className="h-4 w-4" strokeWidth={2.2} /> Italy Office
              </h4>
              <p className="text-sm text-white/75 leading-relaxed">
                Via Arenaccia, 29<br />
                80141 Napoli NA<br />
            ...
            <div>
              <h4 className="text-sm font-semibold text-amber-400 mb-3 uppercase tracking-wider flex items-center gap-2">
                <Phone className="h-4 w-4" strokeWidth={2.2} /> Contact Us
              </h4>
              <div className="flex flex-col gap-2">
                <a href="tel:+919509698089" className="text-sm text-white/75 hover:text-white transition-colors flex items-center gap-2">
                  <Phone className="h-4 w-4 text-amber-400" strokeWidth={2.2} />
                  +91 95096 98089
                </a>
                <a href="mailto:ielts@ielts.my" className="text-sm text-white/75 hover:text-white transition-colors flex items-center gap-2">
                  <Mail className="h-4 w-4 text-amber-400" strokeWidth={2.2} />
                  ielts@ielts.my
                </a>
              </div>
            </div>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-between gap-4 text-xs text-white/60">
            ...
            <p>Crafted for IELTS aspirants worldwide</p>
          </div>
        </div>
      </div>
    </footer>
